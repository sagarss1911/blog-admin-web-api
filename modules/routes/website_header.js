...
router.post('/get_sub_header', authMiddleware.verifyToken, controller.getAllSubHeader);
...
router.get('/get_main_header_sub', authMiddleware.verifyToken, controller.getMainHeader);
...
router.post('/get_main_header', authMiddleware.verifyToken, controller.getAllMainHeader);
